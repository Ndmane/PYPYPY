...
async function Api () {
    ...
    const respons_los_angeles = await fetch ('https://api.open-meteo.com/v1/forecast?latitude=35.0211&longitude=135.7538&current=temperature_2m&hourly=temperature_2m')
